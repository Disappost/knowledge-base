...
Первым делом нужно создать новый адрес, который используется для хранения и отправки монет, для этого воспользуйтесь одним из кошельков от разработчиков и коммьюнити:
