...
По условиям соглашения с SEC команда мессенджера не может продолжать участие в разработке, тем не менее сообщество уже интегрирует TON в мессенджер Telegram посредством ботов и альтернативных версий приложения \(по примеру Telegram X\). 
...
Актуальный баланс [гиверов](faq.md#chto-takoe-givery), сложность и статистику майнинга вы можете найти в разделе [Mining](https://ton.org/mining) на официальном сайте. 

### Кто такие TON Foundation?

К настоящему времени более 40 независимых неинкорпорированных разработчиков из разных регионов работают над проектом в качестве некоммерческого сообщества TON Foundation, финансируемого за счет пожертвований. Вы можете найти их профили в разделе People на GitHub.

Команда TON Foundation планирует объединить все существующие блокчейны в единую сеть. Подобную экосистему можно смело назвать интернетом будущего — Web 3.0, без всяких преувеличений.

### Что такое мастерчейн и воркчейн?

Блокчейн TON делится на мастерчейн и воркчейны, эта особенность архитектуры позволяет легко масштабировать сеть и обеспечивать огромную пропускную способность.
...
Секретная фраза, состоящая из 24 слов 
