...
Майнинг на алгоритме PoW доступен до тех пор, пока на специальных гиверах есть монеты . Затем, когда гиверы будут исчерпаны, будет доступен только PoS и останутся только валидаторы.  
