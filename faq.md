...
Также в сети TON предусмотрена **инфляция**, составляющая **0,6% в год**. Это новые монеты выпускаемые блокчейном в пользу валидаторов, обеспечивающих работу сети.  
