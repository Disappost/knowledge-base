...
Причина в том, что первоначальный выпуск монет в 5 миллиардов TON Coins был переведён в специальные смарт-контракты, Proof-of-Work Givers. Майнинг используется для получения TON Coins из этого смарт-контракта. Контракты Proof-of-Work Givers имеют свои ограничения и иссякнут, как только пользователи добудут все доступные TON Coins.
...
Слово "скам" ассоциируется с компаниями, которые задерживают или вовсе перестают производить выплаты, нарушают условия сотрудничества и обязательства перед партнерами, клиентами и инвесторами. Фактически, скам означает смерть проекта. В нашем случае говорить о таких фактах и предпосылках не приходится.
...
Текущая сеть TON была запущенная Telegram в 2019-ом году в качестве тестовой сети \(с ноября 2019-го она называлась testnet2\) перед запланированным запуском mainnet и выпуском Gram \(которые не состоялись\). Все токены, контракты и транзакции остались такими же какими их сделал Телеграм. Токены сети были выпущены Телеграмом и переведены на Proof-of-work майнинговые смартконтракты, откуда их уже могли добыть текущие держатели. Именно это мы имеем в виду, когда говорим про “оригинальность” сети, в которой, кстати, сохранены вся история транзакций и баланс всех кошельков.. Да, Телеграм больше не участвует в проекте, но технологически это именно “та самая” сеть.
...
### Что, если валидатор не справляется или терпит неудачу?
...
1. Предоставлять механику ликвидации для больших начальных майнеров. Этот контракт будет центром ликвидности откуда будут брать TON Coins при достижении ими all time high \(ATH\) все маркетмейкеры, брокеры и трейдеры. Это будет точкой максимальной ликвидности для крупных держателей.
...
### **Другие проекты используют ноды на Rust, что дает больший TPS. Почему ваш TPS меньше?**

Мы не следим за тестами коллег и не знаем, насколько реальны эти данные. Со своей стороны мы не видим исключительной важности в том, чтобы создать самый быстрый блокчейн в мире. Миссией TON, по мнению ядра его сообщества, является создание новой глобальной сети, объединяющей блокчейны и Интернет на базе технологий TON Blockchain, TON Storage, TON DNS, TON Payments. Для реализации этого видения не требуется рекордов по количеству транзакций. Мы уверены, что даже текущих возможностей TON, без учета доступных улучшениям, достаточно для обеспечения любой рационально ожидаемой нагрузки в реальном мире. 
...
### **У Дурова после истории с SEC осталось примерно 500 млн долларов. Где они?**

Если вы пользуетесь Телеграм, заливаете в него и смотрите в нем фото и видео, читаете новости, общаетесь с друзьями и, в конце концов, задаете в нем этот вопрос, то это и является ответом на вопрос. Средства пошли на содержание и развитие инфраструктуры Телеграм, как того позволяли соглашения с инвесторами в Gram. Но в целом это никак не относится к нашей работе. О деталях лучше узнать в самом Телеграм или у его инвесторов.

### **Создает ли TON Foundation репутационные и юридические риски для Телеграм?**

Развитие проекта TON силами открытого сообщества, не связанного с Телеграм, насколько мы можем судить, не может создать для него каких-либо рисков. Насколько нам известно, никаких ограничений на использование или требований по выведению из строя технологии TON не было высказано ни одним регулятором. SEC требовал запретить распространение токенов Gram в обмен на инвестиции. Это и было исполнено. Претензий к технологии у них не было. SEC — это регулятор финансового рынка, Securities and Exchange Commission. Им не важна технологиях, им важна лишь экономическая суть взаимодействий инвесторов и компаний.  
